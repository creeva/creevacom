...
:page-excerpt: This Nokia device will take a bit to get used to, but most of the problems stem from fat thumbs. The more I do it the faster it becomes.
:page-image: /images/anothertime.jpg
:imagesdir: /images

image::/images/anothertime.jpg[,role="text-center"]
